        ...
        if(!empty($clients)){
            while($row=$clients->fetch_array()){
                ...
                <tr>
                    ...
                    <td>
                        <button class='btn btn-danger openDeleteModal' data-bs-toggle='modal' data-bs-target='#delClientModal' role='button' id='cli_idDel' name='cli_idDel' data-id='".$row['CLI_ID']."'>
            ...
            $clientsHtml.="<tr><th style='color:red';>¡No hay nada que mostrar!</th></tr>";
        }
        return $clientsHtml;
    }
