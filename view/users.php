                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>@mdo</td>
                            <td>
                                <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#editUserModal" role="button">
                            ...
                            <td>
                                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delUserModal" role="button">
    ...
    <div class="modal fade" id="newUserModal" tabindex="-1" aria-labelledby="newUserModal" aria-hidden="true">
        <div class="modal-dialog">
            ...
            <div class="modal-body">
                    <div class="mb-3">
                        <label for="usr_names" class="col-form-label">Nombres:</label>
