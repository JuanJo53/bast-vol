                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>@mdo</td>
                            <td>
                                <button class="btn btn-info" data-bs-toggle="modal" data-bs-target="#editProvModal" role="button">
                            ...
                            <td>
                                <button class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#delProvModal" role="button">
